...
- [Yann LeCun’s Deep Learning Course at CDS](https://cds.nyu.edu/deep-learning/): NYU's Center for Data Science offers an advanced learning course on deep learning and representation techniques. Taught by Yann LeCun and Alfredo Canziani, it covers supervised/unsupervised deep learning, embedding methods, and more. Designed for those with prior data science or graduate-level ML experience.
