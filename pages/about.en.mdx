...
We welcome contributions from the community to enhance the OpenML Guide's richness. Add new resources, courses, or improve existing content on our GitHub repository. Keep an eye out for Edit buttons. 

We need assistance translating the site into various languages. If interested, join our Discord and indicate your interest in the corresponding language, or simply push the repository.
