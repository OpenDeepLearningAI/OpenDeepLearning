...
- [How Stable Diffusion Works](https://mccormickml.com/2022/12/21/how-stable-diffusion-works/): This post is the computer vision counterpart to the previous one. Chris McCormick provides a simple explanation of Stable Diffusion and builds intuition for text-to-image models. For a more accessible introduction, see the [comic](https://www.reddit.com/media?url=https%3A%2F%2Fexternal-preview.redd.it%2FnE6TYpCjGIUABsadDx__1XwRGp2NcMpPPeEXCmzDn14.png%3Fauto%3Dwebp%26s%3Dc8dd3db527223673ea61c09c08650de4196f617f) on r/StableDiffusion.
