...
- [Intro to ML Safety](https://course.mlsafety.org/): Explores researchers' role in shaping the development of robust AI systems for safety and steering it towards a safer direction. The course includes topics like monitoring, alignment, and systemic safety, grounded in real-world safety principles with a systematic framework to mitigate ML safety risks.
