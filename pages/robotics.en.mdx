...
- [Timeline of AI & Robotics](https://www.computerhistory.org/timeline/ai-robotics/): It provides a timeline of significant events in the history of [AI](https://en.wikipedia.org/wiki/Timeline_of_artificial_intelligence) and [robotics](https://en.wikipedia.org/wiki/Robotics), spanning from the 1939 introduction of the relay-based [Elektro](https://en.wikipedia.org/wiki/Elektro) robot, which responded to voice commands, to the incorporation of [Siri](https://en.wikipedia.org/wiki/Siri) as a built-in feature on the Apple iPhone. Siri, a voice-activated personal assistant, demonstrated the ability to comprehend natural language requests. 
