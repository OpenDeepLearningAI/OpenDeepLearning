...
- [Learn Prompting](https://learnprompting.org/docs/intro) is an ideal starting point for newcomers to Generative AI and Prompt Engineering. It covers essential insights, including prompting strategies, popular models, and practical applications.
